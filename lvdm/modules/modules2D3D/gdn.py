...
class NN(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        # print(self.logger.log_dir) #/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_ROOT_DIR/2025training_mnist_v1.0/tensorboard/version_14
...
class SVF(pl.LightningModule):
    ...
    def test_epoch_end(self, outputs):
        ...
        # #save phiinvs as npy
        # np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/phi_disp_VM_S0438_T0441.npy", phiinvs)
        # assert 1>999
        ...
        # sitk.WriteImage(dfmSrcimg, "/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/VM-dfm438.nii.gz")
        ...
        # #save phiinvs as npy
        # np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/phiinv_disp_VM_S0438_T0441.npy", phiinvs)
        # assert 1>908
        ...
        # preds = np.load("/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_MixedOasis_TM_V3/RES/DfmSrc.npy")
        # phiinvs = np.load("/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_MixedOasis_TM_V3/RES/phi_disp.npy")
...
class LDDMM(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        # np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/phi_disp_LM_S0438_T0441.npy", phis)
        # assert 1>999
        ...
        # sitk.WriteImage(dfmSrcimg, "/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/LM-dfm438.nii.gz")
        # print(self.src.shape)
        # assert 1>222


        # phiinvs = phiinv_disp_list[-1].cpu().detach().numpy()
        # np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/phiinv_disp_LM_S0438_T0441.npy", phiinvs)
        # assert 1>908
    ...
    def test_epoch_end_wj(self, outputs):
        ...
        for i in range(batch_size):
            ...
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/src.npy", srcs[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/tar.npy", tars[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_0.npy", VecF_0[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_0.npy", dfmSrc_list_0[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_1.npy", VecF_1[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_1.npy", dfmSrc_list_1[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_2.npy", VecF_2[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_2.npy", dfmSrc_list_2[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_3.npy", VecF_3[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_3.npy", dfmSrc_list_3[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_4.npy", VecF_4[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_4.npy", dfmSrc_list_4[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_5.npy", VecF_5[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_5.npy", dfmSrc_list_5[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_6.npy", VecF_6[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_6.npy", dfmSrc_list_6[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_7.npy", VecF_7[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_7.npy", dfmSrc_list_7[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_8.npy", VecF_8[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_8.npy", dfmSrc_list_8[i, 0])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/V_9.npy", VecF_9[i])
            np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/dfmSrc_9.npy", dfmSrc_list_9[i, 0])
        ...
        plt.tight_layout()
        #save
        # plt.savefig(os.path.join(grids_dir, f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/wj_2.png"))
        plt.show()
...
class QS(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        phis = phi_disp_list[-1].cpu().detach().numpy()
        np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/phi_disp_QS_S0438_T0441.npy", phis)
        assert 1>999
        ...
        dfmSrc = F.interpolate(dfmSrc, scale_factor=2, mode='trilinear')
        dfmSrcimg = dfmSrc[0,0].cpu().detach().numpy(); dfmSrcimg = sitk.GetImageFromArray(dfmSrcimg)
        sitk.WriteImage(dfmSrcimg, "/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/QS-dfm438.nii.gz")
        print(self.src.shape)
        assert 1>222

        phiinvs = phiinv_disp_list[-1].cpu().detach().numpy()
        np.save(f"/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_MELBA/000MELBA_SEG_S0438_T0441/phiinv_disp_QS_S0438_T0441.npy", phiinvs)
        assert 1>908
...
class LDDMM_Optimize(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # np.save("/home/nellie/code/cvpr/BaseLine/DynamiCrafter/lvdm/cardiacV0.npy", velocity_0.detach().cpu().numpy())
        # assert 2>111
