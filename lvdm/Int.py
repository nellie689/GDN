...
def save_dfm_dfmlabel(outputs, ongpuGrad=False, dir="", save_list = [0,2]):
    print(dir)  #/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_ROOT_DIR/2025training_oasisv2.3_simplenop
    if ongpuGrad: 
...
def collect_outputs(outputs,ongpuGrad=False,TSteps=10,dir="",mse_metric=None,saveRes=True,JabDet=None,vie=-1):
    ...
    # np.save("/home/nellie/code/cvpr/BaseLine/DynamiCrafter/2025_SAVE_ROOT_DIR/2025training_mnist_v2.1/phiinv_disp_list_list.npy", np.stack(phiinv_disp_list_list, axis=0))
    # assert 3>123
    if saveRes:
        nums = srcs.shape[0]
...
def plot_boxplot_by_textFiles(textFiles_List, methods_List):
    ...
    plt.savefig(fname="/home/nellie/code/cvpr/BaseLine/DynamiCrafter/main/DiceBrain.png",bbox_inches='tight',dpi=200)
    plt.show()
